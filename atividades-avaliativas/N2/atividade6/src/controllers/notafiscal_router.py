...
from atividade6.model.cliente import Cliente
from atividade6.model.produto import Produto
from atividade6.model.nota import NotaFiscal
from atividade6.model.item import ItemNotaFiscal
from src.server.instance import Server
from src.controllers import objeto_json, response, select_objeto

app, api = Server.app, Server.api

# Clientes Banco de Dados
client1 = Cliente(0, "Pablo Granch", 100, '305.180.330-82', 'fisica')
client2 = Cliente(1, "Manu Rios", 200, '485.069.310-53', 'fisica')
client3 = Cliente(2, "Martina Cariddi", 300, '601.046.020-40', 'fisica')
client4 = Cliente(3, "Claudia Salas", 400, '448.659.850-42', 'fisica')

clientes_db = [client1, client2, client3, client4]

# Produtos Banco de Dados
product1 = Produto(0, 100, 'Arroz Namorado', 5.5)
product2 = Produto(1, 200, 'Feijao São João', 4.5)
product3 = Produto(2, 300, 'Batata Inglesa', 6)
product4 = Produto(3, 400, 'Macarrão Fortaleza', 8)
...
nf4.adcionarItem(item7)
nf4.adcionarItem(item8)
nf4.adcionarItem(item9)
nf4.adcionarItem(item10)
